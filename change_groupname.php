                ...
                <div class="border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 pb-3">
                            <h3 class="pb-5">Change Group Name</h3>
                            <!-- <form action="" method="post"> -->
                                ...
                                <div class="from-group pb-5">
                                    <label id="grp">New Name:</label>&nbsp;
                                    <input type="text" autocomplete="off" placeholder="Name" required id="new_grpname" class="dropdown toggle" data-toggle="dropdown">
                                    ...
                                    <div class="col-sm-6 pb-2"><input type="submit" class="btn btn-primary btn btn-outline-light" value="Alter Name" id="new_name">&nbsp;&nbsp;&nbsp;</div>
