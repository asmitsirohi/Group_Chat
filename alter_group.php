                ...
                <div class="border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 pb-3">
                            <h3 class="pb-5">Alter Group <?php echo $selected_grp; ?></h3>
                            <!-- <form action="" method="post"> -->
                                <div class="from-group pb-3">
                                    <!-- <label id="grp">Group Name:</label>&nbsp;
                                    <input type="text" name="grpname" required id="grpname" value=<?php echo $selected_grp; ?> disabled> -->
                                    <a href='change_groupname.php' class='list-group-item list-group-item-action'><b>Alter_Group_Name</b></a>
                                    <a href='add_member.php' class='list-group-item list-group-item-action'><b>+Add_Memeber</b></a>
                                    <a href='delete_member.php' class='list-group-item list-group-item-action'><b>Delete_Member</b></a>
                                </div>
                                <!-- <div class="from-group pb-5"> -->
                                    <!-- <label id="grp">Delete Member:</label>&nbsp;
                                    <input type="text" name="participant" autocomplete="off" placeholder="Name" required id="del_member" class="dropdown toggle" data-toggle="dropdown">
                                    ...
                                    <!-- <div class="col-sm-6 pb-2"><input type="submit" class="btn btn-primary btn btn-outline-light" value="Delete Member" id="delete">&nbsp;&nbsp;&nbsp;</div> -->
                                    <!-- <div class="col-sm-6 pb-2"><input type="submit" class="btn btn-primary btn btn-outline-light" value="Done" name="create_group" id="done">&nbsp;&nbsp;&nbsp;</div> -->
