                ...
                <div class="border">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9 pb-3">
                            <h3 class="pb-5">Add Member To <?php echo $selected_grp; ?></h3>
                            <!-- <form action="" method="post"> -->
                                ...
                                <div class="from-group pb-5">
                                    ...
                                    <div class="col-sm-6 pb-2"><input type="submit" class="btn btn-primary btn btn-outline-light" value="Add Member" name="participants" id="participants">&nbsp;&nbsp;&nbsp;</div>
